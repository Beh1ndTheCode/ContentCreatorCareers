...
$employer_id = $emp_data['emp'] ?? null; // Fetching the employer id

// Close the language statement
$emp_stmt->close();

// Prepare the main statement for adding the job offer
$stmt = $mysqli->prepare("INSERT INTO job(employer_id, candidate_id, name, type, first_work_date, last_work_date, description) VALUES (?, ?, ?, ?, ?, ?, ?)");
